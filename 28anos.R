...
longitud <- length(seq(1990,2017, by = 1))



if(6 <= longitud ){
  mediaquinquenio1  <- apply(sapply(paises[,-1], as.numeric, 1)[,(1+(1990-1990)):((6-1)+(1990-1990))], 1, mean, na.rm=T)
}

if(6 <= longitud){
  media.municipal <- NULL
  for(i in ((6+1)+(1990-1990)):(longitud+(1990-1990))){
...
salvador <- data.frame(rep(paises[paises$País== "El Salvador",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                       mun= as.numeric(t(paises[paises$País == "El Salvador", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
...
colombia <- data.frame(rep(paises[paises$País== "Colombia",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                       mun= as.numeric(t(paises[paises$País == "Colombia", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
                       upper3 = datosnal$media.nacional+3*datosnal$sd.nacional,
                       upper2 = datosnal$media.nacional+2*datosnal$sd.nacional,
                       upper = datosnal$media.nacional+datosnal$sd.nacional,
                       lower= datosnal$media.nacional-datosnal$sd.nacional,
...
rwanda <- data.frame(rep(paises[paises$País== "Rwanda",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                   mun= as.numeric(t(paises[paises$País == "Rwanda", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
                   upper3 = datosnal$media.nacional+3*datosnal$sd.nacional,
                   upper2 = datosnal$media.nacional+2*datosnal$sd.nacional,
                   upper = datosnal$media.nacional+datosnal$sd.nacional,
                   lower= datosnal$media.nacional-datosnal$sd.nacional,
                   movil= media.movil[rownames(media.movil) == "Rwanda",],
                   sdmovil =sd.movil[rownames(sd.movil) == "Rwanda",]
)

colnames( rwanda) <- c("País", "Año", "Tasa", "Tasa_Rwanda",  "más_3_desv.","más_2_desv.",   "más_1_desv.","menos_1_desv.", "Movil", "SDMovil")
...
syria <- data.frame(rep(paises[paises$País== "Syria",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                    mun= as.numeric(t(paises[paises$País == "Syria", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
                    upper3 = datosnal$media.nacional+3*datosnal$sd.nacional,
                    upper2 = datosnal$media.nacional+2*datosnal$sd.nacional,
                    upper = datosnal$media.nacional+datosnal$sd.nacional,
                    lower= datosnal$media.nacional-datosnal$sd.nacional,
...
afganistan <- data.frame(rep(paises[paises$País== "Afghanistan",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                         mun= as.numeric(t(paises[paises$País == "Afghanistan", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
                         upper3 = datosnal$media.nacional+3*datosnal$sd.nacional,
                         upper2 = datosnal$media.nacional+2*datosnal$sd.nacional,
                         upper = datosnal$media.nacional+datosnal$sd.nacional,
                         lower= datosnal$media.nacional-datosnal$sd.nacional,
...
venezuela <- data.frame(rep(paises[paises$País== "Venezuela",]$País,longitud),  x = datosnal$year, y=datosnal$media.nacional,
                        mun= as.numeric(t(paises[paises$País == "Venezuela", (2+ (1990-1990) ):(2+(1990-1990) + longitud-1)])),
                        upper3 = datosnal$media.nacional+3*datosnal$sd.nacional,
                        upper2 = datosnal$media.nacional+2*datosnal$sd.nacional,
                        upper = datosnal$media.nacional+datosnal$sd.nacional,
                        lower= datosnal$media.nacional-datosnal$sd.nacional,
...
allcountries <- data_frame(venezuela$Año, venezuela$Tasa, venezuela$Tasa_Venezuela, afganistan$Tasa_Afghanistan, colombia$Tasa_Colombia, salvador$Tasa_El_Salvador, rwanda$Tasa_Rwanda, syria$Tasa_Syria)
...
p <- ggplot(data = dd) + geom_line(aes(x= Año, y=Tasa, colour = País))  +
  ...
  ggtitle(paste0("Países con violencia crónica o aguda en los últimos 28 años")) +
